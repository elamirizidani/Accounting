...
const buildQuotationFormData = (quotation = {}) => ({
  ...quotation,
  billedBy: getRecordId(quotation?.billedBy),
  billedTo: getRecordId(quotation?.billedTo),
  quotationDate: toDateInputValue(quotation?.quotationDate || new Date()),
...
const QuotationModal = ({ show, handleClose, quotation = {} }) => {
  ...
  const initialFormData = buildQuotationFormData(quotation);
  ...
  useEffect(() => {
    if (quotation) {
      const nextFormData = buildQuotationFormData(quotation);
        ...
        <div className="quotation-modal">
          <Form onSubmit={handleSubmit}>
            <Modal.Header closeButton>
              <Modal.Title>{isEditing ? 'Edit Proforma' : 'New Proforma'}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                  ...
                  <div className="col-md-6">
                    ...
                    <Form.Group>
                      ...
                      <RichTextEditor
                        ...
                        placeholder="Example: Payment due within 15 days. Quoted services remain valid for 30 days."
                      />
                    </Form.Group>
