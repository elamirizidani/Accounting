...
const AddLPO = ({ show, handleClose, quotation = {} }) => {
    ...
    const addNewItem = (service = '', name = '', description = '') => {
        if (!items.some(item => item.service === service)) {
            ...
            setItems([...items, { 
                ...
                codeName: selectedCode.code, 
                service, name, description: description, 
                quantity: 1, unitCost: 0, vat: 0, total: 0 }]);
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (quotation?._id)
                await updateData(`lpo/${quotation?._id}`, payload);
            else
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Modal.Body>
                            <div className="container">
                                {/* Quotation Details */}
                                <div className="mb-4">
                                    <h2 className="h5 mb-3 section-title">LPO Details</h2>
                      ...
                      <Form.Control type="text" value={generateQuotationId()} readOnly disabled/>
                                ...
                                <div className="mb-4">
                                    <Row>
                                        ...
                                        <Col md={6}>
                                            <Card className='p-3'>
                                                <h3 className="h5 mb-3">Vendor Information</h3>
                                                <Form.Group className="mb-3">
